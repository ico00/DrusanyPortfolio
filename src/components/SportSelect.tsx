...
const SPORTS_RAW = [
  { slug: "football", label: "Football", icon: Trophy },
  { slug: "basketball", label: "Basketball", icon: Trophy },
  { slug: "handball", label: "Handball", icon: Trophy },
  { slug: "auto-moto", label: "Auto-Moto", icon: Trophy },
  { slug: "martialarts", label: "Martial Arts", icon: Trophy },
  { slug: "fencing", label: "Fencing", icon: Trophy },

  { slug: "athletics", label: "Athletics", icon: Trophy },
] as const;

export const SPORTS = [...SPORTS_RAW].sort((a, b) =>
...
export default function SportSelect({
  ...
  const selected = SPORTS.find((c) => c.slug === valueNorm);
        ...
        {open && (
          ...
          >
            ...
            {SPORTS.map((sport) => {
              ...
              const isSelected = valueNorm === sport.slug;
              return (
                <button
                  key={sport.slug}
                  type="button"
