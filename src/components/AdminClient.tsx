  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="mb-10 flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500">
              Local use during development (npm run dev)
            </p>
          </div>
          <Link
            href="/"
        ...
        >
          ...
          {!category && (
            <p className="mb-6 rounded-lg bg-zinc-800/80 py-4 text-center text-sm text-zinc-500">
              Select a category above to add images.
            </p>
          )}
        ...
        <section>
          {!category ? (
            <p className="rounded-lg border border-zinc-800 bg-zinc-900/30 py-12 text-center text-zinc-500">
              Select a category above to view and manage its gallery.
            </p>
          ) : loadingGallery ? (
          ...
          >
            ...
            >
              <div className="mb-4 flex items-center justify-between">
                <h3 className="text-lg font-medium text-zinc-200">Edit description</h3>
                <button
                  type="button"
                  onClick={() => setEditingId(null)}
              ...
              <form onSubmit={handleUpdate} className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setEditingId(null)}
                    className="rounded-lg border border-zinc-700 px-4 py-2.5 text-sm text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-200"
                  >
                    Cancel
                  </button>
                </div>
