...
- **Sigurnost i pouzdanost** – Path traversal zaštita, ograničenje uploada (20 MB), magic bytes provjera, HTML sanitizacija (rel="noopener noreferrer" na vanjskim linkovima), rate limiting, file locking za JSON, čišćenje orphan datoteka pri promjeni blog slug-a
