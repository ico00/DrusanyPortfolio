...
- **Blog** – Stranice s BlockNote WYSIWYG editorom (blokovi, naslovi, citati, tablice)
...
- **Blog:** Kreiranje i uređivanje blog postova – title, **custom DatePicker** za datum, thumbnail, sadržaj (BlockNote)
